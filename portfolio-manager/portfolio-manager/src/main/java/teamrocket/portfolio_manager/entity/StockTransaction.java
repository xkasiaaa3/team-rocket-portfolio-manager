...
public class StockTransaction {
    ...
    public StockWithAmountDTO toAmountDTO() {
        return new StockWithAmountDTO(stock.getId(), stock.getStockSymbol(),stock.getStockName(),stock.getCurrency(),stock.getCurrentPrice(),amount);
    }
}
